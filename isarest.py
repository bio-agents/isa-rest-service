...
from isaagents.convert import isatab2json, isatab2sra, json2isatab, json2sra, sampletab2isatab, sampletab2json, \
    isatab2sampletab, json2sampletab, magetab2json
from isaagents.net import mw2isa
from isaagents.convert.isatab2cedar import ISATab2CEDAR
from isaagents import isajson, isatab
        ...
        if request.mimetype == "application/zip":
            try:
                ...
                with zipfile.ZipFile(file_path, 'r') as z:
                    ...
                    # Convert
                    src_dir = os.path.normpath(tmp_dir)
                    tab2cedar = ISATab2CEDAR('http://www.isa-agents.org/')
